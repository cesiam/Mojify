        ...
        <Section icon={<Users className="size-5" />} title="Developers" id="developers">
          <div className="space-y-12">
            ...
            <DeveloperCard
              ...
              bio="Nadia is a careful listener to human emotion, especially the subtle feelings we experience but struggle to name. She studied Computer Science and Statistics at Swarthmore and is now pursuing her Master's in Data Science at Harvard, where she explores how computational systems intersect with cognition and creative expression. For nearly a decade, she has been building a Nameless Emotion Dictionary—an ongoing collection of feelings that exist in lived experience but not in vocabulary. In her recent AI & Art research, she examined how generative and multimodal models translate emotions across text, images, and latent spaces, asking what happens when we try to encode feelings that do not yet have names. Mojify grows from this same question. If our emotional lives are richer than the words and emojis we have, how might AI help us surface more precise expressions? Nadia is interested in building systems that do not just categorize emotion, but make space for the ones we almost miss."
